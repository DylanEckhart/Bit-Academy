...
-- -----------------------------------------------------
-- Table `id17762295_bitacademydb`.`desc_has_idplanning`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17762295_bitacademydb`.`desc_has_idplanning` (
  `plannings_idplanning` INT NOT NULL,
  `tickets_Description` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`plannings_idplanning`),
  INDEX `fk_desc_has_idplanning_tickets1_idx` (`tickets_Description` ASC),
  CONSTRAINT `fk_desc_has_idplanning_plannings1`
    FOREIGN KEY (`plannings_idplanning`)
    REFERENCES `id17762295_bitacademydb`.`plannings` (`idplanning`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_desc_has_idplanning_tickets1`
